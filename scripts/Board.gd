...
# === ГАРАНТИРОВАННО ПРОХОДИМАЯ ГЕНЕРАЦИЯ ===
# Симулируем игру: на каждом шаге берём 3 свободные позиции
# и назначаем им одну тройку. Если зашли в тупик - пробуем заново.
